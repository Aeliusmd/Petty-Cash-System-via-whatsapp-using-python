...
"""
Add Employee Script
Usage: python -m backend.app.db.add_employee <phone> <name> <grade> <location> [role]
   or: python -m app.db.add_employee <phone> <name> <grade> <location> [role]
"""
...
def main():
    ...
    if not args or args[0] == 'list':
        ...
        print('Usage:')
        print('  python -m app.db.add_employee list')
        print('  python -m app.db.add_employee <phone> "<name>" <grade> <location> [role]')
